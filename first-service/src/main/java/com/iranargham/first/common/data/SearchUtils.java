...
public class SearchUtils {
    ...
    // private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");//todo::correct this
    private static DateFormat dateFormat = new SimpleDateFormat("yyyyMMdd");//todo::correct this
    ...
    public static List<Searchable> createSearchableFrom(String filters, Searchable[] searchables) throws ServiceException {
        ...
        List<Searchable> compiled = new ArrayList<>();
    ...
    public static PageRequest getPageRequest(SearchablePage searchablePage) throws ServiceException {
        String direction = searchablePage.getDirection() != null ? searchablePage.getDirection() : "ASC";
